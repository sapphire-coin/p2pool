...
nets = dict(
    ...
    sapphire=math.Object(
        PARENT=networks.nets['sapphire'],
        SHARE_PERIOD=15,
        CHAIN_LENGTH=12*60*60//10,
        REAL_CHAIN_LENGTH=12*60*60//10,
        TARGET_LOOKBEHIND=200,
        SPREAD=3,
        IDENTIFIER='a0a1a2a3c2a68569'.decode('hex'),
        PREFIX='10e314a531b11cc9'.decode('hex'),
        P2P_PORT=35049,
        MIN_TARGET=0,
        MAX_TARGET=2**256//2**20 - 1,
        PERSIST=True,
        WORKER_PORT=35050,
        BOOTSTRAP_ADDRS='198.46.142.119 p2pool.sapphirecoin.in'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-sapphire',
        VERSION_CHECK=lambda v: True,
    ),
